...
def run_simulation(dt, t_stance, duration,
    ...
    if graphic_mode:
        ...
        p.resetDebugVisualizerCamera(cameraDistance=0.11, cameraYaw = 50, cameraPitch=-60, cameraTargetPosition=[0,0,0])
...
t_stance = 0.2
run_simulation(
    dt=1./2400., t_stance=t_stance, duration=t_stance,
    f=1/(2*t_stance), A_lat=-pi/5, th0_lat=0, th0_abd=pi/10, thf_abd=-pi/2, z_rotation=pi/6,
    girdle_friction=0.0001, body_friction=0.0001, last_link_friction=0.01, leg_friction=0.0001,
    # Kp_lat=0, Kp_r_abd=0, Kp_l_abd=0, Kp_flex=0,
    # Kv_lat=0, Kv_r_abd=0, Kv_l_abd=0, Kv_flex=0,
    Kp_lat=1e7, Kp_r_abd=9e7, Kp_l_abd=9e7, Kp_flex=0.,
    Kv_lat=0.3e7, Kv_r_abd=3e7, Kv_l_abd=3e7, Kv_flex=0.,
    keep_in_check=False, graphic_mode=True, plot_graph_joint=True, plot_graph_COM=True,
    video_logging=False, video_name="./video/traveling wave/first_trial_hinged_tail.mp4"
)