...
t_stance = 2
run_simulation(
    dt=1./240., t_stance=t_stance, duration=2,
    f=1/(2*t_stance), A_lat=-pi/4, th0_lat=0.0, th0_abd=pi/8, thf_abd=-pi/4, z_rotation=pi/6,
    ...
    Kp_lat=50e3, Kp_r_abd=70e3, Kp_l_abd=70e3, Kp_flex=50,
    Kv_lat=15e3, Kv_r_abd=20e3, Kv_l_abd=20e3, Kv_flex=10,
    keep_in_check=False, graphic_mode=True, plot_graph_joint=True, plot_graph_COM=True,
    video_logging=True, video_name="./video/traveling wave/first_trial_hinged_tail.mp4"
)